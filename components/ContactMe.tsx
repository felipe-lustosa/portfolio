...
const ContactMe = (props: Props) => {
    ...
    const onSubmit: SubmitHandler<Inputs> = (formData) => (window.location.href = `mailto:felipe_lustosaa@hotmail.com?subject=${formData.subject}&body=Hi, my name is ${formData.name}. ${formData.message} (${formData.email})`);
